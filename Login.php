...
$Url1 = "https://holacu9900.herokuapp.com/Register.php"; //REGISTER.PHP
$Url2 = "https://holacu9900.herokuapp.com/User.php"; //USER.PHP
$Url3 = "https://holacu9900.herokuapp.com/ActionManager.php"; //ActionManager.php
...
ExitAlert('تم اخذ الرمز من شخص اخر');
}
...
if($content[dark74encode($username)]   <> null){
	...
	if($content[dark74encode($username)]["password"] == dark74encode($password)){
		...
		return;
					...
					ExitAlert(" تم ايقاف الرمز راسل المطور");
					return;
					}
			...
			ExitAlert("الرمز او اليوزر غلط حبيبي");
			return;
}
	}
	else{
		ExitAlert("ليس في القائمة");
		return;
		}
?>