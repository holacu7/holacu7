...
if potor == 3 then nanab() end
if potor == 4 then HOME () end
...
if love == 1 then skill() end
if love == 2 then buled()end
if love == 3 then phpd() end
GLWW=-1
end
...
local ll = {0x9588, 0xB8, 0x60, 0x178, 0x58, 0x10, 0x80}---
local lll = S_Pointer(l, ll, true)
gg.addListItems({{address = lll, flags = 16, value =0, freeze = true}}) 
gg.toast("🇮🇶🅾🅵🅵🇮🇶")
...
---------------البناء----------
function skill()
 F = gg.alert("|البناء في السماء|", "[̲̅تشغيل̲̅]", "[̲̅تعطيل̲̅]")
  if F == 1 then
    gg.clearResults()
    gg.setRanges(32)
    gg.searchNumber("2.31347680092;3.6734198e-40", gg.REGION_C_BSS, false, gg.SIGN_FUZZY_EQUAL, 0, -1)
    gg.searchNumber("3.67341985e-40", gg.REGION_C_BSS, false, gg.SIGN_FUZZY_EQUAL, 0, -1)
    gg.getResults(999)
  ...
  elseif F == 2 then
    gg.clearResults()
    gg.setRanges(32)
    gg.searchNumber("6.6734198e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
    gg.getResults(999)
    gg.editAll("3.67341985e-40", gg.TYPE_FLOAT)
    gg.clearResults()
  end
end
